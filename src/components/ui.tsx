...
// ---------------------------------------------------------------------------
// Design System Tokens & Base Classes
// ---------------------------------------------------------------------------
...
export const labelClass = "mb-1.5 block text-xs font-semibold uppercase tracking-wider text-slate-700";
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        {hint && !error && <span className="mb-1.5 text-xs text-slate-400">{hint}</span>}
      </div>
      {children}
...
export function ErrorNote({
  ...
  return (
    <div className="rounded-2xl border border-rose-200 bg-rose-50/70 p-4 text-rose-800">
