  ...
  if (!currentUser) {
    return (
      <div className="mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-xs">
        ...
        <Link to="/messages" className="mt-3 inline-block text-xs font-semibold text-violet-700 hover:underline">
          ← Back to Messages
        </Link>
      </div>
    );
  ...
  if (error && messages.length === 0) {
    return (
      <div className="space-y-4">
        ...
        <Link to="/messages" className="text-xs font-semibold text-violet-700 hover:underline">
          ← Back to Messages
        </Link>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <div className="rounded-2xl border border-slate-200/90 bg-white shadow-xs overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Direct message conversation</p>
            </div>
          </div>
        ...
        {/* Input box */}
        <form onSubmit={send} className="flex gap-2 border-t border-slate-100 p-4 bg-white">
          <input
            value={draft}
